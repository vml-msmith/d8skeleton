...
if (!isset($options['p'])) {
  PrettyPrint::p("Running with default processes npm, gulp-build.");
  $options['p'] = array('npm', 'gulp-build');
}
...
// echo shell_exec('mv /usr/local/nvm/versions/node/v4.2.3/bin/versions/node/v6.9.1/lib/node_modules /usr/local/nvm/versions/node/v4.2.3/bin/versions/node/v6.9.1/lib/node_modules.tmp');
// echo shell_exec($cmd_prefix . 'npm --version && npm cache clean -f && npm install -g n && n stable && npm install -g gulp gulp-cli ');
